...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        checktextdomain: {
            options: {
                text_domain: ['post-h2-adverts', 'IWORKS_RATE_TEXTDOMAIN', 'IWORKS_OPTIONS_TEXTDOMAIN'],
            ...
            files: {
                src: ['post-h2-adverts.php', 'vendor/**/*.php'], //all php 
                expand: true,
            },
        },
